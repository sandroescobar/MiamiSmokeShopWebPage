...
DOWNLOAD_DIR = os.path.join(BASE_DIR, "downloads", "79th")
...
cleaned_path = os.path.join(DOWNLOAD_DIR, "inventory_79th_clean.csv")
...
try:
    ...
    if result.returncode == 0:
        print("✅ Database updated with 79th Street inventory!")
    else:
